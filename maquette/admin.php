            ...
            <div class="d-flex flex-row" style="margin: 31px 0px;">
                ...
                <div class="border rounded-0 d-inline-flex" style="background-color: #ffffff;height: 456px;width: 514px;margin: -11px 0px 0px 0px;">
                    <div class="border-dark" style="background-color: #ffffff;height: 396px;width: 339px;margin: -1px 0px 0px 0px;">
                        ...
                        <p style="margin: 0px;color: rgb(129,129,129);">&nbsp; &nbsp;Utilisateur</p><input class="form-control-sm" type="text" required="" placeholder="jow" style="margin: 0px 0px 0px 13px;height: 40px;width: 302px;font-size: 17px;">
                        <p style="margin: 0px;color: rgb(129,129,129);">&nbsp; &nbsp;Mot de passe</p><input class="form-control-sm" type="password" required="" placeholder=".........." style="width: 302px;height: 40px;margin: 0px 0px 0px 13px;padding: 0px 0px 22px 10px;font-size: 40px;">
                        <p style="margin: 0px;color: rgb(129,129,129);">&nbsp; &nbsp;Confirmer Mot de password</p><input class="form-control-sm" type="password" required="" placeholder=".........." style="width: 302px;height: 40px;margin: 0px 0px 0px 13px;font-size: 40px;padding: 0px 0px 22px 10px;">
                        <div
                            class="d-inline-flex">
